...
//    [self.playSlider setThumbImage:[AliyunUtil imageWithNameInBundle:@"al_play_settings_radiobtn_normal" skin:skin] forState:UIControlStateNormal];
    ...
    [self.playSlider setThumbImage:[AliyunUtil imageWithNameInBundle:@"alivcPlayThumb"] forState:UIControlStateNormal];
    
    self.playSlider.minimumTrackTintColor = [UIColor colorWithHexString:@"00c1de"];;
