...
//    [self.fullScreenButton setBackgroundImage:[AliyunUtil imageWithNameInBundle:@"al_play_screen_full" skin:skin] forState:UIControlStateNormal];
    [self.fullScreenButton setImage:[AliyunUtil imageWithNameInBundle:@"alivc_fullScreen"] forState:UIControlStateSelected];
    [self.fullScreenButton setImage:[AliyunUtil imageWithNameInBundle:@"alivc_fullScreen"] forState:UIControlStateNormal];
